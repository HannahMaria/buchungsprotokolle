...
public class DynamicFormular extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dynamic_formular);
        ...
        switch (v.getId()){
            ...
            case R.id.button_submit_list:
                ...
                if(checkIfValidAndRead()){
                    ...
                    Intent intent = new Intent(DynamicFormular.this, ActivityCricketers.class);
